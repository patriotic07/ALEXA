    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if "visionias" in url:
                ...
                vid_id = url.split('/')[-2]
                url = "https://madxpw.onrender.com/" + "https://d1d34p8vz63oiq.cloudfront.net/" + "/master.m3u8?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..tYGt4VtnZBMTdL3ZWMK9WRhGRozwkh0Xc2At1K2Vlmk"
